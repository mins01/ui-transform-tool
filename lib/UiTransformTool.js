class UiTransformTool{
    ...
    moveable(b=null){
        if(b===null){
            return this.tool.classList.contains('moveable')
        }else if(b===false){
            return this.tool.classList.remove('moveable')
        }else{
            return this.tool.classList.add('moveable')
        }
    }
    transformable(b=null){
        if(b===null){
            return this.tool.classList.contains('transformable')
        }else if(b===false){
            return this.tool.classList.remove('transformable')
        }else{
            return this.tool.classList.add('transformable')
        }
    }
